...
const AddCheckup = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log({ name, dateOfCheckup, comments, image });
    };
        ...
        <div id="form">
            <form onSubmit={handleSubmit}>
                <div className="inputs">
                    ...
                    <input type="text" name='dateOfCheckup' placeholder='Date of Checkup' autoComplete='off' autoCorrect='on' required value={dateOfCheckup} onChange={e => setDateOfCheckup(e.target.value)} />
                ...
                <div className="file-upload-container">
                    ...
                    {imagePreview && (
                        <img className="image-preview" src={imagePreview} alt="Checkup Preview" />
                    )}
                </div>
            </form>
        </div>
